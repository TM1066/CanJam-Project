...
public static class PredictColourName
{
    public static Color32[] colours; //List<Color32> colours;

    public static List<string> colourNames = new List<string>() {"White","Grey","Black","Light Red","Red","Dark Red","Light Orange","Orange","Light Brown",
    ...
    public static string GetColourName(Color32 colourToPredict)
    {
        colours = Colours.colours;


        List<Color32> predictions = new List<Color32>();
        ...
        try //haha, you thought I stopped doing this, sike
        {
            ...
            predictions.Clear();
            var currentColour = new Color32();


            //setting current prediction target variables
            currentColour = colourToPredict;
            ...
            return colourNames[Array.IndexOf(colours,predictions[0])] + "~";
        }
